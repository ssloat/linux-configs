...
alias la='ls -A'
alias l='ls --hide="*.pyc"'
gg() { grep -i $1 `find . -name "*.py" -o -name "*.html"`; }
...
#export PATH="/home/stephen/miniconda2/bin:$PATH"

# The next line updates PATH for the Google Cloud SDK.
if [ -f '/home/stephen/google-cloud-sdk/path.bash.inc' ]; then source '/home/stephen/google-cloud-sdk/path.bash.inc'; fi
